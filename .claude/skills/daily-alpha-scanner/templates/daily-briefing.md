...
- **Score**: composite score 0-100 based on 6 dimensions: narrative + momentum + smart money + social + security + liquidity
...
*Generated by Daily Alpha Scanner v2.0 | Data sources: OKX OnchainOS API, opennews, Reddit, xreach/opentwitter*
